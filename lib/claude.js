...

{
  ...
  "aiThreatAnalysis": "5-8 sentences providing a detailed, task-level analysis of how AI threatens their specific role — not their function in general, but what THEY do day-to-day given their title and level. Name specific AI tools or categories (e.g., 'code generation tools like Copilot', 'AI-powered financial modeling', 'automated content generation'). Distinguish between tasks that are already being automated vs. those on a 2-3 year horizon vs. those that remain human-dependent. Factor in their seniority — a VP of Engineering faces different AI threats than a junior developer.",
  ...
  "aiTaskBreakdown": [
    {
      ...
      "aiTools": "Name 1-2 specific real AI tools or platforms that automate this",
  ...
  "aiMitigatingFactors": "3-4 sentences about what specifically protects THIS person. Is it their seniority and the relationship/judgment layer of their role? Their cross-functional experience? Their industry specialization? Their geographic market? Be specific — 'leadership roles are harder to automate' is too generic. Instead: 'Their VP-level role at ${person.currentCompany} involves stakeholder alignment, org design, and strategic prioritization — tasks where AI assists but doesn't replace.'",
  ...
  "companyHealthSummary": "3-4 sentences on what the company data reveals about job security at ${person.currentCompany}. Reference specific metrics from the data: headcount trends, hiring velocity, attrition patterns, functional composition shifts. What do these signals mean for someone at THIS person's level and function within the org?",
...
Be specific to this person's industry, company type, and seniority level.
...
function fallbackNarrative(person, scores) {
  ...
  return {
    ...
    aiThreatAnalysis: `The ${person.currentFunction} function faces ${scores.aiRisk >= 60 ? "significant" : "moderate"} AI disruption risk. AI tools are increasingly automating tasks traditionally performed in this function, though the impact varies significantly by seniority level and specific responsibilities.`,
    aiTaskBreakdown: [],
    aiMarketContext: null,
    aiEvolutionPath: null,
    aiMitigatingFactors: `${person.currentLevel === "C-Team" || person.currentLevel === "VP" ? "Executive-level authority involving strategic decision-making, stakeholder management, and organizational leadership provides substantial insulation from direct AI automation" : person.currentLevel === "Director" || person.currentLevel === "Manager" ? "Management responsibilities including team leadership, cross-functional coordination, and judgment-intensive decisions offer meaningful protection" : "Individual contributor roles face more direct automation exposure, though domain expertise and relationship networks provide differentiation"}.`,
    companyHealthSummary: `${person.currentCompany} shows ${scores.companyInstability <= 30 ? "strong growth trajectory and organizational stability" : scores.companyInstability <= 50 ? "stable positioning with some areas to monitor" : "concerning workforce signals that warrant attention"} based on workforce data analysis.`,
