...
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
Name: ${person.name}
Current Title: ${person.currentTitle || "Unknown"}${person.titleIsGeneric ? `
⚠️ GENERIC TITLE WARNING: The data source only has "${person.currentTitle}" — no specialty information. This significantly limits the specificity of this assessment. In your overviewSummary, acknowledge this clearly and naturally: e.g., "Because your title in our data source shows only '${person.currentTitle}' without a specialty, this assessment is based on your broader ${person.currentFunction} background — if you share your actual role focus in the chat, we can sharpen the analysis." Do not pretend you know their specific specialty. Write the best analysis you can at the function+level, but be honest about the limitation.` : ""}
